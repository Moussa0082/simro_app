...
class PrixMarcheConsommationNew {
    int? enquete;
    String? produit;
    int? unite;
    int? isSynced;
  ...
  PrixMarcheConsommationNew copyWith({
    int? enquete,
    String? produit,
    int? unite,
    int? isSynced,
    ...
    return PrixMarcheConsommationNew(
  ...
  factory PrixMarcheConsommationNew.fromMap(Map<String, dynamic> map) {
    return PrixMarcheConsommationNew(
